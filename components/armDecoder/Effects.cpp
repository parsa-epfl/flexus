...
//    tt = 0x80;
//  }
//  DBG_( Tmp, ( << anInstruction << " regWinTrapType isFill: " << isFill << " OTHERWIN: " << std::hex << anInstruction.core()->getOTHERWIN() << " WSTATE: " << anInstruction.core()->getWSTATE() << std::dec) );
...
//  void invoke(SemanticInstruction & anInstruction) {
//    DBG_( Tmp, ( << anInstruction << " Checking if save will raise.") );//NOOSHIN
//    if (anInstruction.core()->getCANSAVE() == 0) {

//      anInstruction.setWillRaise( regWinTrapType( false, anInstruction ) );
//      DBG_( Tmp, ( << anInstruction << " SaveWindow Raise exception: " << anInstruction.willRaise()  ) );//NOOSHIN
...
//  void invoke(SemanticInstruction & anInstruction) {
//    DBG_( Tmp, ( << anInstruction << " Checking if FLUSHW will raise.") );//NOOSHIN
//    if (8 /*NWINDOWS*/ - 2 - anInstruction.core()->getCANSAVE() != 0) {
//      anInstruction.setWillRaise( regWinTrapType( false, anInstruction ) );
//      DBG_( Tmp, ( << anInstruction << " FlushW Raise exception: " << anInstruction.willRaise()  ) );//NOOSHIN
//      anInstruction.core()->takeTrap( boost::intrusive_ptr<Instruction>(& anInstruction), anInstruction.willRaise());
//    }
//  }
//  void describe(std::ostream & anOstream) const {
...
//  void invoke(SemanticInstruction & anInstruction) {
//    DBG_( Tmp, ( << anInstruction << " Checking if restore will raise.") );//NOOSHIN
//    if (anInstruction.core()->getCANRESTORE() == 0) {

//      anInstruction.setWillRaise( regWinTrapType( true, anInstruction ) );
//      DBG_( Iface, ( << anInstruction << " RestoreWindow Raise exception: " << anInstruction.willRaise()  ) );//NOOSHIN
//      anInstruction.core()->takeTrap( boost::intrusive_ptr<Instruction>(& anInstruction), anInstruction.willRaise());
//    }
//  }
//  void describe(std::ostream & anOstream) const {
...
//    DBG_( Tmp, ( << anInstruction << " Save register window privileged effects."  ) );
//    Effect::invoke(anInstruction);
//  }
...
//    anInstruction.setOperand(kocCANSAVE, anInstruction.core()->getCANSAVE() );
//    anInstruction.setOperand(kocCANRESTORE, anInstruction.core()->getCANRESTORE() );
//    DBG_( Tmp, ( << anInstruction << " Restore register window privileged effects."  ) );
//    Effect::invoke(anInstruction);
//  }
...
//    DBG_( Tmp, ( << anInstruction << " Saved register window."  ) );
//    Effect::invoke(anInstruction);
//  }
...
//    anInstruction.setOperand(kocCLEANWIN, anInstruction.core()->getCLEANWIN() );
//    anInstruction.setOperand(kocOTHERWIN, anInstruction.core()->getOTHERWIN() );
//    DBG_( Tmp, ( << anInstruction << " Restored register window."  ) );
//    Effect::invoke(anInstruction);
//  }
...
//    DBG_( Tmp, ( << anInstruction << " saving a register window. CWP=" << cwp ) );
//    Effect::invoke(anInstruction);
//  }
...
//    anInstruction.setOperand(kocCWP, cwp);
//    DBG_( Tmp, ( << anInstruction << " restoring a register window. CWP=" << cwp ) );
//    Effect::invoke(anInstruction);
//  }
