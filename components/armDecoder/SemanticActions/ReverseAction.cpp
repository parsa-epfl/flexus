...
struct ReorderAction : public PredicatedSemanticAction
{
  ...
  ReorderAction(SemanticInstruction * anInstruction, eOperandCode anInputCode, eOperandCode anOutputCode, uint8_t aContainerSize, bool is64)
    : PredicatedSemanticAction(anInstruction, 1, true)
    , theInputCode (anInputCode)
    , theOutputCode (anOutputCode)
...
struct CountAction : public PredicatedSemanticAction
{
  ...
  CountAction(SemanticInstruction * anInstruction, eOperandCode anInputCode, eOperandCode anOutputCode, eCountOp aCountOp, bool is64)
    : PredicatedSemanticAction(anInstruction, 1, true)
    , theInputCode (anInputCode)
    , theOutputCode (anOutputCode)
    , theCountOp (aCountOp)
...
struct CRCAction : public PredicatedSemanticAction
{
  ...
  CRCAction(SemanticInstruction * anInstruction, uint32_t aPoly, eOperandCode anInputCode, eOperandCode anInputCode2,eOperandCode anOutputCode, bool is64)
    : PredicatedSemanticAction(anInstruction, 1, true)
    , theInputCode (anInputCode)
    , theOutputCode (anOutputCode)
    , thePoly (aPoly)
...
{
    ReverseAction * act(new(anInstruction->icb()) ReverseAction( anInstruction, anInputCode, anOutputCode, is64) );
...
{
    CRCAction * act(new(anInstruction->icb()) CRCAction( anInstruction, aPoly, anInputCode, anInputCode2, anOutputCode, is64));
    return predicated_action( act, act->predicate() );
}
