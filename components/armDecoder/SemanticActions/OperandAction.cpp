...
struct OperandAction : public PredicatedSemanticAction {
  ...
  OperandAction( SemanticInstruction * anInstruction, eOperandCode anOperand, eOperandCode aResult, boost::optional<eOperandCode> aBypass )
...
( SemanticInstruction * anInstruction
  ...
  OperandAction * act(new(anInstruction->icb()) OperandAction( anInstruction, anOperand, aResult, aBypass) );
