  ...
  , public UncountedComponent
{
  ...
  public:
    ...
    int32_t numOperands() const { return theNumOperands; }
...
struct predicated_dependant_action
  : predicated_action
  , dependant_action
{
...
multiply_dependant_action
updateVirtualAddressAction(SemanticInstruction* anInstruction, eOperandCode aCode = kAddress);
