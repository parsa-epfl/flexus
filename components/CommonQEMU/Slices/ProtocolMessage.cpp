...
ProtocolMessage::ProtocolMessage(tAddress anAddress,
                                 uint32_t aDest,
                                 tVC aVC,
                                 node_id_t aSrc,
...
std::ostream&
operator<<(std::ostream& anOstream, const ProtocolMessage& aPacket)
{
...
boost::intrusive_ptr<DirectoryEntry const>
ProtocolMessage::dirEntry() const
{
    DBG_Assert(theLocal);
    return theDirEntry;
}
boost::intrusive_ptr<TransactionTracker>
ProtocolMessage::transactionTracker() const
{
    return theTracker;
}

void
ProtocolMessage::setType(Protocol::ProtocolMessageType aType)
{
...
tVC
networkMessageTypeToVC(ProtocolMessageType msg_type)
{
