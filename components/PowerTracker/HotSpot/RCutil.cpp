 ...
 */
void rk4_core(void * model, double * y, double * k1, void * p, int32_t n, double h, double * yout, slope_fn_ptr f) {
  int32_t i;
  double * t, *k2, *k3, *k4;
  k2 = dvector(n);
  k3 = dvector(n);
...
double rk4(void * model, double * y, void * p, int32_t n, double h, double * yout, slope_fn_ptr f) {
  int32_t i;
...
/* dst = src1 + scale * src2	*/
void scaleadd_dvector (double * dst, double * src1, double * src2, int32_t n, double scale) {
