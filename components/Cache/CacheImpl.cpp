...
class FLEXUS_COMPONENT(Cache)
{
  ...
  public:
    ...
    void push(interface::FrontSideIn_Snoop const&, index_t anIndex, MemoryTransport& aMessage)
    {
        ...
        DBG_(VVerb, (<< "received | FrontSideIn(Snoop){" << anIndex << "} | " << *(aMessage[MemoryMessageTag])));
    ...
    void push(interface::FrontSideIn_Prefetch const&, index_t anIndex, MemoryTransport& aMessage)
    {
        ...
        aMessage[MemoryMessageTag]->coreIdx() = anIndex;
        DBG_(VVerb, (<< "received | FrontSideIn(Prefetch){" << anIndex << "} | " << *(aMessage[MemoryMessageTag])));
        if (aMessage[TransactionTrackerTag]) { aMessage[TransactionTrackerTag]->setDelayCause(name(), "Front Rx"); }
    ...
    void push(interface::FrontSideIn_Request const&, index_t anIndex, MemoryTransport& aMessage)
    {
        ...
        aMessage[MemoryMessageTag]->coreIdx() = anIndex;
        DBG_(VVerb, (<< "received | FrontSideIn(Request){" << anIndex << "} | " << *(aMessage[MemoryMessageTag])));
    ...
    // BackeSideIn_Reply
    //-----------
    bool available(interface::BackSideIn_Reply const&) { return !theBackSideIn_ReplyBuffer; }
    ...
    // BackeSideIn_Request
    //-----------
    bool available(interface::BackSideIn_Request const&) { return !theBackSideIn_RequestBuffer; }
    ...
    void busCycle()
    {
        ...
        for (uint32_t i = 0; i < cores; i++) {
            ...
            while (!theController->FrontSideOut_I[i].empty() && FLEXUS_CHANNEL_ARRAY(FrontSideOut_I, i).available()) {
                ...
                DBG_(VVerb, (<< "sent | FrontSideOut_I(){" << i << "} | " << *(transport[MemoryMessageTag])));
        ...
        if (cfg.NoBus) {
            ...
            while (!theController->BackSideOut_Request.empty() && FLEXUS_CHANNEL(BackSideOut_Request).available() &&
                   (theController->BackSideOut_Snoop.empty() || theController->BackSideOut_Snoop.headTimestamp() >
                                                                  theController->BackSideOut_Request.headTimestamp()) &&
                   (theController->BackSideOut_Reply.empty() || theController->BackSideOut_Reply.headTimestamp() >
                                                                  theController->BackSideOut_Request.headTimestamp())) {
            ...
            if ( // Back side buffer gets max priority if it can transfer
              ...
              theBackSideIn_RequestBuffer && !theController->BackSideIn_Request[0].full()) {
                ...
                theBusTxCountdown           = transferTime(theBusContents);
                        ...
                        // messages
              !theController->BackSideOut_Request.empty() && FLEXUS_CHANNEL(BackSideOut_Request).available() &&
              ...
              theController->BackSideOut_Request.empty() && !theController->BackSideOut_Prefetch.empty() &&
              ...
              !theController->BackSideOut_Snoop.empty() && FLEXUS_CHANNEL(BackSideOut_Snoop).available() &&
              (theController->BackSideOut_Reply.empty() ||
              ...
              !theController->BackSideOut_Reply.empty() && FLEXUS_CHANNEL(BackSideOut_Reply).available()) {
            ...
            switch (theBusDirection) {
                ...
                case kToBackSideIn_Reply:
                    if (!theController->BackSideIn_Reply[0].full()) {
                        DBG_(VVerb, (<< "received | BackSideIn(Reply){} | " << *(theBusContents[MemoryMessageTag])));
                ...
                case kToBackSideIn_Request:
                    if (!theController->BackSideIn_Request[0].full()) {
                        DBG_(VVerb, (<< "received | BackSideIn(Request){0} | " << *(theBusContents[MemoryMessageTag])));
                ...
                case kToBackSideOut_Reply:
                    if (FLEXUS_CHANNEL(BackSideOut_Reply).available()) {
                        ...
                        theBusContents[MemoryMessageTag]->coreIdx() = flexusIndex();
                        DBG_(VVerb, (<< "sent | BackSideOut(Reply){} | " << *(theBusContents[MemoryMessageTag])));
                ...
                case kToBackSideOut_Prefetch:
                    if (FLEXUS_CHANNEL(BackSideOut_Prefetch).available()) {
                        ...
                        DBG_(VVerb, (<< "sent | BackSideOut(Prefetch){} | " << *(theBusContents[MemoryMessageTag])));
