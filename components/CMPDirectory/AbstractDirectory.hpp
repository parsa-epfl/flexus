...
public:
  ...
  virtual EvictBuffer<_EState>* getEvictBuffer() = 0;
...
#include <components/CMPDirectory/InfiniteDirectory.hpp>
#include <components/CMPDirectory/StdDirectory.hpp>
#include <components/CMPDirectory/RegionDirectory.hpp>
#include <components/CMPDirectory/RTDirectory.hpp>
#include <components/CMPDirectory/TaglessDirectory.hpp>

namespace nCMPDirectory {

template<typename _State, typename _EState>
AbstractDirectory<_State, _EState>* constructDirectory(const DirectoryInfo & params) {
  ...
  } else if (strcasecmp(type.c_str(), "region") == 0 || strcasecmp(type.c_str(), "reg") == 0) {
