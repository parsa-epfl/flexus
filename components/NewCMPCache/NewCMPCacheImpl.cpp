...
#include <components/NewCMPCache/CMPCacheController.hpp>

#define DBG_DefineCategories NewCMPCache
#define DBG_SetDefaultOps AddCat(NewCMPCache)
#include DBG_Control()

#define FLEXUS_BEGIN_COMPONENT NewCMPCache
#include FLEXUS_BEGIN_COMPONENT_IMPLEMENTATION()

namespace nNewCMPCache {
...
private:
  ...
  std::unique_ptr<CMPCacheController> theController;

public:

  FLEXUS_COMPONENT_CONSTRUCTOR(NewCMPCache)
  ...
  void initialize() {
    ...
    theController.reset(new CMPCacheController(statName(),
                        cfg.Cores,
                        cfg.BlockSize,
                        (int)flexusIndex(),
                        cfg.Banks,
  ...
  //DirectoryDrive
  //----------
  void drive(interface::NewCMPCacheDrive const &) {
...
} //End Namespace nNewCMPCache

FLEXUS_COMPONENT_INSTANTIATOR( NewCMPCache, nNewCMPCache );

#include FLEXUS_END_COMPONENT_IMPLEMENTATION()
#define FLEXUS_END_COMPONENT NewCMPCache
