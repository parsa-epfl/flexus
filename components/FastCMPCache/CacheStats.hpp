...
struct CacheStats {
  ...
  CacheStats(std::string const &theName)
      : ReadReq_kModified_ZeroSharers(theName + "-ReadReq:kModified:ZeroSharers"),
        ...
        ,
        NonAllocatingStoreReq_kModified_ZeroSharers(theName +
                                                    "-NonAllocatingStoreReq:kModified:ZeroSharers"),
        NonAllocatingStoreReq_kModified_OneSharer(theName +
                                                  "-NonAllocatingStoreReq:kModified:OneSharer"),
        NonAllocatingStoreReq_kModified_ManySharers(theName +
                                                    "-NonAllocatingStoreReq:kModified:ManySharers"),
        NonAllocatingStoreReq_kExclusive_ZeroSharers(
            theName + "-NonAllocatingStoreReq:kExclusive:ZeroSharers"),
        NonAllocatingStoreReq_kExclusive_OneSharer(theName +
                                                   "-NonAllocatingStoreReq:kExclusive:OneSharer"),
        NonAllocatingStoreReq_kExclusive_ManySharers(
            theName + "-NonAllocatingStoreReq:kExclusive:ManySharers"),
        NonAllocatingStoreReq_kShared_ZeroSharers(theName +
                                                  "-NonAllocatingStoreReq:kShared:ZeroSharers"),
        NonAllocatingStoreReq_kShared_OneSharer(theName +
                                                "-NonAllocatingStoreReq:kShared:OneSharer"),
        NonAllocatingStoreReq_kShared_ManySharers(theName +
                                                  "-NonAllocatingStoreReq:kShared:ManySharers"),
        NonAllocatingStoreReq_kInvalid_ZeroSharers(theName +
                                                   "-NonAllocatingStoreReq:kInvalid:ZeroSharers"),
        NonAllocatingStoreReq_kInvalid_OneSharer(theName +
                                                 "-NonAllocatingStoreReq:kInvalid:OneSharer"),
        NonAllocatingStoreReq_kInvalid_ManySharers(theName +
                                                   "-NonAllocatingStoreReq:kInvalid:ManySharers")
        ...
        ,
        Hits_Read(theName + "-Hits:Read"), Hits_Write(theName + "-Hits:Write"),
        Hits_Fetch(theName + "-Hits:Fetch"), Hits_NAStore(theName + "-Hits:NAStore")
