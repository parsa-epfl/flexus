/*! \file InclusiveMOESIControllerImpl.hpp
 * \brief
 *
 * Defines the interfaces that the CacheController and the InclusiveMOESIControllerImpl
...
class InclusiveMOESIControllerImpl : public BaseCacheControllerImpl {
private:
...
private:
  InclusiveMOESIControllerImpl( CacheController * aController,
                                CacheInitInfo  * aInit,
                                bool    anAlwaysNAck );
...
private:
  ...
  friend std::ostream & operator<<( std::ostream & os, const InclusiveMOESIControllerImpl::State & state);

}; // class InclusiveMOESIControllerImpl
