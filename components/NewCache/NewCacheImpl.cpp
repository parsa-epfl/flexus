...
#include <components/NewCache/NewCache.hpp>
...
#define DBG_DefineCategories NewCache
#define DBG_SetDefaultOps AddCat(NewCache)
#include DBG_Control()
#define DBG_DefineCategories NewCacheMissTracking
#include DBG_Control()

#define FLEXUS_BEGIN_COMPONENT NewCache
...
class FLEXUS_COMPONENT(NewCache) {
  FLEXUS_COMPONENT_IMPL(NewCache);
...
public:
  FLEXUS_COMPONENT_CONSTRUCTOR(NewCache)
...
FLEXUS_COMPONENT_INSTANTIATOR( NewCache, nNewCache );

FLEXUS_PORT_ARRAY_WIDTH( NewCache, FrontSideOut_D )           {
  return (cfg.Cores);
}
FLEXUS_PORT_ARRAY_WIDTH( NewCache, FrontSideOut_I )           {
  return (cfg.Cores);
}
FLEXUS_PORT_ARRAY_WIDTH( NewCache, FrontSideIn_Snoop )      {
  return (cfg.Cores);
}
FLEXUS_PORT_ARRAY_WIDTH( NewCache, FrontSideIn_Request )    {
  return (cfg.Cores);
}
FLEXUS_PORT_ARRAY_WIDTH( NewCache, FrontSideIn_Prefetch )   {
  return (cfg.Cores);
}

#include FLEXUS_END_COMPONENT_IMPLEMENTATION()
#define FLEXUS_END_COMPONENT NewCache
