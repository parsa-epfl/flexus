...
#include "InclusiveMOESIControllerImpl.hpp"
...
////////////////////////////////////////////////////////////////////////////////
// InclusiveMOESIControllerImpl class

// Register the Implementation so that it can be created automagically
REGISTER_CONTROLLER_IMPLEMENTATION(InclusiveMOESIControllerImpl, "InclusiveMOESI");
...
BaseCacheControllerImpl * InclusiveMOESIControllerImpl::createInstance(std::list<std::pair<std::string, std::string> > &args, const ControllerParams & params) {
  ...
  return new InclusiveMOESIControllerImpl(params.first, params.second, anAlwaysNAck);
}

InclusiveMOESIControllerImpl::InclusiveMOESIControllerImpl ( CacheController * aController,
...
boost::tuple<bool, bool, Action> InclusiveMOESIControllerImpl::doRequest( MemoryTransport      transport,
    bool                 has_maf_entry,
...
#if 0
  // Perform lookup, select action and update cache state if necessary
  boost::tuple<bool, bool, Action> InclusiveMOESIControllerImpl::doRequest( MemoryMessage_p        msg,
...
//   }
    ...
    bool InclusiveMOESIControllerImpl::evictBlock(LookupResult_p victim) {
    ...
    void InclusiveMOESIControllerImpl::allocateBlock(LookupResult_p result, MemoryAddress aBlockAddress) {
    ...
    // Action InclusiveMOESIControllerImpl::handleBackMessage(MemoryMessage_p msg, TransactionTracker_p tracker) {
    Action InclusiveMOESIControllerImpl::handleBackMessage(MemoryTransport transport) {
      MemoryMessage_p msg = transport[MemoryMessageTag];
      TransactionTracker_p tracker = transport[TransactionTrackerTag];
    ...
    //Action InclusiveMOESIControllerImpl::finalizeSnoop(MemoryMessage_p msg, TransactionTracker_p tracker, LookupResult_p result) {
    Action InclusiveMOESIControllerImpl::finalizeSnoop(MemoryTransport transport, LookupResult_p result) {
    ...
    //Action InclusiveMOESIControllerImpl::handleSnoopMessage(MemoryMessage_p msg, TransactionTracker_p tracker) {
    Action InclusiveMOESIControllerImpl::handleSnoopMessage(MemoryTransport transport) {
    ...
    // at this cache level.
    //Action InclusiveMOESIControllerImpl::handleIprobe(bool aHit, MemoryMessage_p fetchReq, TransactionTracker_p tracker) {
    Action InclusiveMOESIControllerImpl::handleIprobe(bool aHit, MemoryTransport transport) {
    ...
    bool InclusiveMOESIControllerImpl::idleWorkAvailable() {
    ...
    MemoryMessage_p InclusiveMOESIControllerImpl::getIdleWorkMessage(ProcessEntry_p process) {
    ...
    void InclusiveMOESIControllerImpl::removeIdleWorkReservations(ProcessEntry_p process, Action & action) {
    ...
    //Action InclusiveMOESIControllerImpl::handleIdleWork(MemoryMessage_p msg, TransactionTracker_p tracker) {
    Action InclusiveMOESIControllerImpl::handleIdleWork(MemoryTransport transport) {
    ...
    //Action InclusiveMOESIControllerImpl::handleWakeSnoop ( MemoryMessage_p      msg,
    //                TransactionTracker_p tracker ) {
    Action InclusiveMOESIControllerImpl::handleWakeSnoop ( MemoryTransport transport ) {
    ...
    void InclusiveMOESIControllerImpl::dumpEvictBuffer() const {
