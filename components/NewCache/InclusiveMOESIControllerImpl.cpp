...
std::tuple<bool, bool, Action> InclusiveMOESIControllerImpl::doRequest( MemoryTransport      transport,
    bool                 has_maf_entry,
...
#if 0
  // Perform lookup, select action and update cache state if necessary
  std::tuple<bool, bool, Action> InclusiveMOESIControllerImpl::doRequest( MemoryMessage_p        msg,
