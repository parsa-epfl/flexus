  ...
  public:
    void initialize()
    {
        if (cfg.UsageEnable || cfg.RepetEnable || cfg.PrefetchEnable) {
            theTraceTracker.initSGP(flexusIndex(),
                                    cfg.CacheLevel,
                                    cfg.UsageEnable,
                                    cfg.RepetEnable,
                                    cfg.BufFetchEnable,
        ...
        if (!cfg.PrefetchEnable) { theTraceTracker.initOffChipTracking(flexusIndex()); }
    }
    ...
    {
        if (cfg.RepetEnable) { theTraceTracker.saveSGP(flexusIndex(), cfg.CacheLevel, aDirName); }
    }
