...
bool getNodeCoord ( const int32_t nodeId, 
                    int32_t * coord )
{
  int32_t 
    dim = 0,
...
bool writeS2S ( const int32_t * coord1,
                const int32_t   port1,
                const int32_t * coord2,
                const int32_t   port2 )
{
  outFile << "Top Switch " 
...
bool writeBasicRoute ( int32_t * coord1,
                       int32_t * coord2,
                       int32_t   outPort,
                       int32_t   outVC )
{
...
bool generateRouteEntry ( int32_t * coord1, 
                          int32_t * coord2  )
{
  int
    dim,
