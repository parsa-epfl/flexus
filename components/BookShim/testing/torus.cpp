...
bool generateDeadlockFreeMeshRoute ( int32_t currNode,
                                     int32_t destNode );

bool generateDeadlockFreeTorusRoute ( int32_t currNode,
                                      int32_t destNode );
...
bool writeS2S ( const int32_t       node1,
...
bool writeBasicRoute ( int32_t currNode,
                       int32_t destNode,
                       Direction outPort,
                       int32_t outVC ) {
