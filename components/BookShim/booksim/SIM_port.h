...
#define PARM_v_channel		2	/* # of virtual channels per virtual message class*/
...
#define PARM_connect_type	TRANS_GATE		/* crossbar connector type TRISTATE_GATE or TRANS_GATE */
#define PARM_trans_type		N_GATE				/* crossbar transmission gate type */
...
#define PARM_in_buffer_type     SRAM	/*buffer model type, SRAM or REGISTER*/ // COMMENT FROM MEHDI: REGISTER doesnt work! just use SRAM
...
#define PARM_sw_in_arb_model	MATRIX_ARBITER	/* input side arbiter model type, MATRIX_ARBITER , RR_ARBITER, QUEUE_ARBITER*/
