#ifndef FLEXUS_FASTCMPDIRECTORY_DIRECTORYSTATS_HPP_INCLUDED
#define FLEXUS_FASTCMPDIRECTORY_DIRECTORYSTATS_HPP_INCLUDED
...
#endif /* FLEXUS_FASTCMPDIRECTORY_TOPOLOGYSTATS_HPP_INCLUDED */
