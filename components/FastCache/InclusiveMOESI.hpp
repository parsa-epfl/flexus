...
public:
  InclusiveMOESI(bool using_traces, message_function_t fwd, message_function_t cnt, invalidate_function_t inval, bool DowngradeLRU = false, bool SnoopLRU = false)
...
#endif
    DECLARE_REQUEST_ACTION( kModified, kReadAccess, SendNone, NoAllocate, E_State, UpdateLRU, FillDirty, HitReadModified );
    DECLARE_REQUEST_ACTION( kModified, kWriteAccess, SendNone, NoAllocate, E_State, UpdateLRU, FillDirty, HitWriteModified );
    DECLARE_REQUEST_ACTION( kModified, kNAWAccess, SendNone, NoAllocate, E_State, UpdateLRU, FillDirty, HitNAWModified );
    DECLARE_REQUEST_ACTION( kModified, kFetchAccess, SendNone, NoAllocate, SameState, UpdateLRU, FillValid,  HitFetchModified );
    ...
    DECLARE_REQUEST_ACTION( kOwned,  kReadAccess, SendNone,  NoAllocate, SameState, UpdateLRU, FillValid,  HitReadOwned );
    DECLARE_REQUEST_ACTION( kOwned,  kWriteAccess, SendUpgrade, NoAllocate, E_State, UpdateLRU, FillWritable, MissWriteOwned );
    DECLARE_REQUEST_ACTION( kOwned,  kNAWAccess, SendUpgrade, NoAllocate, E_State, UpdateLRU, FillWritable, MissNAWOwned );
    DECLARE_REQUEST_ACTION( kOwned,  kFetchAccess, SendNone,  NoAllocate, SameState, UpdateLRU, FillValid,  HitFetchOwned );
    DECLARE_REQUEST_ACTION( kOwned,  kUpgrade,  SendUpgrade, NoAllocate, E_State, UpdateLRU, FillWritable, MissUpgradeOwned );
    DECLARE_REQUEST_ACTION( kOwned,  kEvictClean, SendNone,  NoAllocate, SameState, UpdateLRU, NoResponse,  HitEvictOwned );
    if (using_traces) {
      DECLARE_REQUEST_ACTION( kOwned, kEvictWritable, SendNone,  NoAllocate, SameState, UpdateLRU, NoResponse,  MissEvictWOwned );
      DECLARE_REQUEST_ACTION( kOwned, kEvictDirty, SendUpgrade, NoAllocate, M_State, UpdateLRU, NoResponse,  MissEvictDOwned );
    } else {
    ...
    DECLARE_REQUEST_ACTION( kShared, kNAWAccess, SendUpgrade, NoAllocate, E_State, UpdateLRU, FillWritable, MissNAWShared );
...
#define MM MemoryMessage
    ...
    if (SnoopLRU) {
      ...
      DECLARE_SNOOP_ACTION( kExclusive, MM::ReturnReq, MM::ReturnReply, DoSnoop, DependState, HitReturnReqExclusive, false, true );
    } else {
      DECLARE_SNOOP_ACTION( kModified, MM::ReturnReq, MM::ReturnReplyDirty, NoSnoop, S_State, HitReturnReqModified, false, false );
      DECLARE_SNOOP_ACTION( kExclusive, MM::ReturnReq, MM::ReturnReply, DoSnoop, DependState, HitReturnReqExclusive, false, false );
    }
    DECLARE_SNOOP_ACTION( kOwned,  MM::ReturnReq, MM::ReturnReplyDirty, NoSnoop, S_State, HitReturnReqOwned, false, false );
    ...
    DECLARE_SNOOP_ACTION( kOwned,  MM::Invalidate, MM::InvalidateAck, DoSnoop, I_State, HitInvalidateOwned, false, true );
    ...
    if (DowngradeLRU) {
      DECLARE_SNOOP_ACTION( kModified, MM::Downgrade, MM::DownUpdateAck, DoSnoop, O_State,  HitDowngradeModified, false, true );
      DECLARE_SNOOP_ACTION( kExclusive, MM::Downgrade, SnoopDepend,  DoSnoop, DependState, HitDowngradeExclusive, false, true );
    } else {
      DECLARE_SNOOP_ACTION( kModified, MM::Downgrade, MM::DownUpdateAck, DoSnoop, O_State,  HitDowngradeModified, false, false );
      DECLARE_SNOOP_ACTION( kExclusive, MM::Downgrade, SnoopDepend,  DoSnoop, DependState, HitDowngradeExclusive, false, false );
    }
