...
public:
  ...
  RTCache(int32_t aBlockSize, int32_t aNumSets, int32_t anAssociativity, evict_function_t anEvict,
          region_evict_function_t aRegionEvict, invalidate_function_t aSendInvalidate,
          int32_t anIndex, Flexus::SharedTypes::tFillLevel aLevel, int32_t aRegionSize,
          int32_t anRTAssoc, int32_t anRTSize, int32_t anERBSize, bool aSkewBlockSetIndex,
