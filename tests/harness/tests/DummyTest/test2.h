...
static bool avail2(Flexus::Core::index_t idx)
{
...
static void manip2(Flexus::Core::index_t idx, int &payload)
{
...
TEST(DummyTest2, DummyInstantiation)
{
	...
	aJumpTable.wire_available_getState = avail2;
	aJumpTable.wire_manip_getState = manip2;
