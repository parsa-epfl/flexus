#include <components/FetchAddressGenerate/FetchAddressGenerateImpl.cpp>
...
public:
  ...
  static void InitializeFetchAddressGenerateConfiguration(FetchAddressGenerateConfiguration_struct& aCfg, uint32_t MaxFetchAddress, uint32_t MaxBPred,uint32_t Threads,bool EnableRAS, bool EnableTCE, bool EnableTrapRet,  uint32_t BTBSets, uint32_t BTBWays) {
    aCfg.MaxFetchAddress = MaxFetchAddress;
