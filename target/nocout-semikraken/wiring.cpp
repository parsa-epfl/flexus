...
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( CMPCache, theL2Cfg, theL2, FIXED, DIVIDE, 6 );
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( PhantomCPU, thePhantomCfg, thePhantomCPU, SCALE_WITH_SYSTEM_WIDTH, MULTIPLY, 1);
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( MemoryLoopback, theMemoryCfg, theMemory, FIXED, DIVIDE, 6 );
