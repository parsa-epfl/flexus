...
struct ComponentInterface
{
    ...
    static Flexus::Core::aux_::port<Port, AvailableFn, ManipulateFn> get_channel(Port const&,
                                                                                 AvailableFn avail,
                                                                                 ManipulateFn manip,
    ...
    template<class Port, typename AvailableFn, typename ManipulateFn>
    static Flexus::Core::aux_::port<Port, AvailableFn, ManipulateFn> get_channel_array(
      Port const&,
      AvailableFn avail,
      ManipulateFn manip,
      Flexus::Core::index_t aComponentIndex,
      Flexus::Core::index_t aPortIndex,
      Flexus::Core::index_t aPortWidth)
    {

        DBG_Assert(aPortIndex < aPortWidth, (<< "PortIndex: " << aPortIndex << " Width: " << aPortWidth));

        return Flexus::Core::aux_::port<Port, AvailableFn, ManipulateFn>(avail,
                                                                         manip,
                                                                         aComponentIndex * aPortWidth + aPortIndex);
    }
