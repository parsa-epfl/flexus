...
#define BOOST_PP_VA_FILTER_OP(elem, pred, ...)                                                     \
  pred BOOST_PP_VA_LEFT_COMMA(__VA_ARGS__)                                                         \
...
#define BOOST_PP_VA_FOLD_LEFT_I(op, state, first, ...)                                             \
  BOOST_PP_VA_SKIP_N(                                                                              \
      ...
      BOOST_PP_VA_WHILE_HEAD_REM(BOOST_PP_VA_FOLD_LEFT_I_PRED, BOOST_PP_VA_FOLD_LEFT_I_OP,         \
...
#define BOOST_PP_VA_FOR(pred, op, macro, ...)                                                      \
  BOOST_PP_VA_WHILE_HEAD_REM(BOOST_PP_VA_FOR_PRED, BOOST_PP_VA_FOR_OP, (), pred, op, macro,        \
                             (__VA_ARGS__))
...
#define BOOST_PP_VA_INSERT(i, elem, ...)                                                           \
  BOOST_PP_VA_FIRST_N(i, __VA_ARGS__),                                                             \
      elem BOOST_PP_VA_LEFT_COMMA(BOOST_PP_VA_SKIP_N(i, __VA_ARGS__))

#define BOOST_PP_VA_IS_EMPTY(...)                                                                  \
  BOOST_PP_VA_HEAD(BOOST_PP_VA_CAT1(                                                               \
...
#define BOOST_PP_VA_IS_EMPTYM(...)                                                                 \
  BOOST_PP_VA_HEAD(BOOST_PP_VA_IS_EMPTYM_I(BOOST_PP_VA_IS_EMPTYM_ __VA_ARGS__))
...
#define BOOST_PP_VA_IS_TUPLE(...)                                                                  \
  BOOST_PP_VA_HEAD(BOOST_PP_VA_IS_TUPLE_I(BOOST_PP_VA_IS_TUPLE_TEST __VA_ARGS__))
...
#define BOOST_PP_VA_LAST_N(n, ...)                                                                 \
  BOOST_PP_VA_SKIP_N(BOOST_PP_SUB(BOOST_PP_VA_SIZE(__VA_ARGS__), n), __VA_ARGS__)
...
#define BOOST_PP_VA_POP_BACK(...)                                                                  \
  BOOST_PP_VA_FIRST_N(BOOST_PP_DEC(BOOST_PP_VA_SIZE(__VA_ARGS__)), __VA_ARGS__)
...
#define BOOST_PP_VA_SIZE(...)                                                                      \
  BOOST_PP_VA_WHILE(BOOST_PP_VA_SIZE_PRED, BOOST_PP_VA_SIZE_OP,                                    \
...
#define BOOST_PP_VA_WHILE(pred, op, ...)                                                           \
  BOOST_PP_VA_REM(BOOST_PP_EXPAND(BOOST_PP_VA_HEAD BOOST_PP_WHILE(                                 \
      BOOST_PP_VA_WHILE_PRED, BOOST_PP_VA_WHILE_OP, ((__VA_ARGS__), pred, op))))
