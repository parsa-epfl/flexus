...
struct CalcException {
  ...
  CalcException(std::string const &aReason) : theReason(aReason) {
  }
};
...
inline void serialize(Archive &ar,
                      ::boost::intrusive_ptr<Flexus::Stat::aux_::StatValueBase> const &t,
...
public:
  StatValueHandle();
  StatValueHandle(Stat *aStat, boost::intrusive_ptr<StatValueBase> aValue,
...
public:
  ...
  StatValueArrayHandle(Stat *aStat, boost::intrusive_ptr<StatValueArrayBase> aValue,
                       boost::intrusive_ptr<StatUpdaterBase> anUpdater);
  StatValueArrayHandle(const StatValueArrayHandle &aHandle);
  StatValueArrayHandle &operator=(const StatValueArrayHandle &aHandle);
  friend std::ostream &operator<<(std::ostream &anOstream,
                                  StatValueArrayHandle const &aValueHandle);
  void print(std::ostream &anOstream, std::string const &options = std::string(""));
