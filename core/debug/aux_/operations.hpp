...
#define DBG__internal_STREAM_TRICK(args) static_cast<std::stringstream&&>(std::stringstream() << std::dec args).str()
...
#define DBG__internal_MakeOutput_Message_1(args, state) /*entry*/ .set("Message", DBG__internal_STREAM_TRICK(args)) /**/
...
#define DBG__internal_MakeOutput_SetNumeric_D(name, val) /*entry*/ .set(BOOST_PP_STRINGIZE(name), val) /**/
...
#define DBG__internal_NextState_AddCategory_0_Condition(args, state)                                                   \
    DBG__internal_NextState_AddCategory_0_D(                                                                           \
      DBG__internal_State_SetCategoryCondition(state, DBG_Cats::BOOST_PP_CAT(args, _debug_enabled))) /**/

/* Indicate that there are categories */
#define DBG__internal_NextState_AddCategory_0_D(state) DBG__internal_State_SetHasCategories(state, 1) /**/
...
#define DBG__internal_MakeOutput_Condition(args, state) /*entry*/ .append("Condition", BOOST_PP_STRINGIZE(args)) /**/
...
/* append to the existing categories */
#define DBG__internal_NextState_Condition_1(args, state) DBG__internal_State_AddCondition(state, args) /**/
...
#define DBG__internal_NextState_Condition_0_D(state) DBG__internal_State_SetHasCondition(state, 1) /**/
...
#define DBG__internal_NextState_Core(args, state) DBG__internal_NextState_AddCategory(Core, state) /**/
...
#define DBG__internal_NextState_NoDefaultOps(args, state) DBG__internal_State_SetSuppressDefaultOps(state, 1) /**/
