...
#define DBG__internal_make_cmd_1(cmd, input, state)                                                                    \
    DBG__internal_make_cmd_named(cmd, state, BOOST_PP_CAT(DBG__internal_REMAP_COMMAND_, Unnamed input))
...
#define DBG__internal_recognize_0(input)                                                                               \
    DBG__internal_recognize_0_D(DBG__internal_recognize_test BOOST_PP_CAT(DBG__internal_VALID_COMMAND_, input))
...
#define DBG__internal_INPUT_OK(d, state) DBG__internal_INPUT_OK_input(BOOST_PP_TUPLE_ELEM(3, 2, state)) /**/
...
#define DBG__internal_PROCESS(Sev, input)                                                                              \
    BOOST_PP_WHILE(DBG__internal_INPUT_OK,                                                                             \
...
#define DBG__internal_PROCESS_DEFAULT_OPS(output, State, empty)                                                        \
    BOOST_PP_CAT(DBG__internal_PROCESS_DEFAULT_OPS_, DBG__internal_State_GetSuppressDefaultOps(State))                 \
    (output, State, empty) /**/

#define DBG__internal_PROCESS_DEFAULT_OPS_0(output, State, empty)                                                      \
    BOOST_PP_WHILE(DBG__internal_INPUT_OK, DBG__internal_PROCESS_STEP, (output, State, DBG__internal_DEFAULT_OPS)) /**/
...
#define DBG__internal_FINALIZE(output, state, empty)                                                                   \
    if (Flexus::Dbg::Debugger::theDebugger->theMinimumSeverity <= DBG__internal_State_GetSev(state) &&                 \
        ...
        if (DBG__internal_BUILTIN_CONDITIONS(state) && DBG__internal_State_GetCondition(state)) {                      \
            ...
            BOOST_PP_CAT(DBG__internal_FINALIZE_Categories_, DBG__internal_State_GetHasCategories(state))              \
...
#define DBG__internal_BUILTIN_CONDITIONS(state) (DBG__internal_State_GetCategoryCondition(state)) /**/

#define DBG__internal_PROCESS_DBG(Sev, input) DBG__internal_PROCESS_DBG_0(DBG__internal_PROCESS(Sev, input)) /**/
