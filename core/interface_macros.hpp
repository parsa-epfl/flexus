...
#define FLEXUS_IFACE_DYNWIDTH(Name) static Flexus::Core::index_t width(configuration& cfg, Name const&); /**/
...
#define FLEXUS_IFACE_JUMPTABLE_Impl(Name)                                                                              \
    ...
    void (*BOOST_PP_CAT(wire_manip_, Name))(Flexus::Core::index_t anIndex, iface::Name::payload & aPayload) = 0; /**/
...
#define FLEXUS_COMPONENT_INTERFACE(ComponentName, ParameterList)                                                       \
    ...
    struct BOOST_PP_CAT(ComponentName, Interface)                                                                      \
      : public Flexus::Core::ComponentInterface                                                                        \
    {                                                                                                                  \
