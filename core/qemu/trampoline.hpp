...
struct select_arity<0>
{
    ...
    struct FreeFnImpl
    {
        static typename TargetSignature::result_type trampoline() { return FreeFn(); }
    };
};
...
struct select_arity<1>
{
    ...
    template<class TargetSignature,
             class T,
             class TImpl,
...
struct select_arity<9>
{
    ...
    struct AddInFnImpl
    {
        static typename TargetSignature::result_type trampoline(typename TargetSignature::arg1_type arg1,
                                                                ...
                                                                typename TargetSignature::arg9_type arg9)
        {
            return (&((reinterpret_cast<QemuObject<T>*>(arg1))->theObject)
                      ->*MemberFn)(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        }
    };
};
