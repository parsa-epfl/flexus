...
unsigned long long extractBitsWithBounds(unsigned long long input, unsigned upperBitBound, unsigned lowerBitBound);
unsigned long long extractBitsWithRange(unsigned long long input, unsigned lowerBound, unsigned numBits);
