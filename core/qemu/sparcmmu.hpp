#ifndef FLEXUS_QEMU_SPARC_MMU_HPP_INCLUDED
#define FLEXUS_QEMU_SPARC_MMU_HPP_INCLUDED
...
namespace Qemu {
namespace MMU {
void fm_init_mmu_from_qemu(mmu_t * mmu, Flexus::Qemu::API::conf_object_t * chmmu);
}
}
}
#endif
