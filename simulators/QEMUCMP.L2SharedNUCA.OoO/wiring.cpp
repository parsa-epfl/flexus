...
namespace Flexus {
//Simulator Name
std::string theSimulatorName = "QEMUCMP.L2SharedNUCA.OoO v1.0";
}
...
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( MemoryLoopback, theMemoryCfg, theMemory, SCALE_WITH_SYSTEM_WIDTH, DIVIDE, 16 );
