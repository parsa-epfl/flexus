...
namespace Flexus {
	//Simulator Name
	std::string theSimulatorName = "CMP.L2SharedNUCA.DRAMSim.OoO v1.0";
}
...
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( DRAMController, theMemoryCfg, theMemory, SCALE_WITH_SYSTEM_WIDTH, DIVIDE, 16);
