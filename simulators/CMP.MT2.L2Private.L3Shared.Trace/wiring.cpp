...
namespace Flexus {
//Simulator Name
std::string theSimulatorName = "CMP.MT2.L2Private.L3Shared.Trace v1.0";
}
...
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( FastCache, theL2Cfg, theL2, SCALE_WITH_SYSTEM_WIDTH, DIVIDE, THREADS_PER_CORE);
