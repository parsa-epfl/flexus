...
namespace Flexus {
//Simulator Name
std::string theSimulatorName = "TraceCMPFlex 3.0";
}
...
#   define BLOCK_SIZE  64
  ...
  theL2Cfg.ReplPolicy.initialize("LRU"); /* CMU-ONLY */
  theL2Cfg.ReuseDistStats.initialize(false); /* CMU-ONLY */
  theL2Cfg.PerfectPlacement.initialize(false); /* CMU-ONLY */
