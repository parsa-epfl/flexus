...
CREATE_CONFIGURATION( CmpDirectory, "directory", theDirectoryCfg );
CREATE_CONFIGURATION( MultiNic1, "nic", theNicCfg );
CREATE_CONFIGURATION( ContentionFreeNetwork, "network", theNetworkCfg );
...
bool initializeParameters() {
  ...
  theNetworkCfg.RouterDelay.initialize( 3 );
  theNetworkCfg.ChannelBandwidth.initialize( 16 );
...
FLEXUS_INSTANTIATE_COMPONENT_ARRAY( CmpDirectory, theDirectoryCfg, theDirectory, SCALE_WITH_SYSTEM_WIDTH, DIVIDE, 1 );
...
FLEXUS_INSTANTIATE_COMPONENT( ContentionFreeNetwork, theNetworkCfg, theNetwork );
