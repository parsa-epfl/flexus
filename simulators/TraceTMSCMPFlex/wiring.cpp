...
namespace Flexus {
//Simulator Name
std::string theSimulatorName = "TraceTMSCMPFlex 1.0";
}
...
CREATE_CONFIGURATION( TMSTracer, "tracer", theTMSTracerCfg );
...
FLEXUS_INSTANTIATE_COMPONENT( TMSTracer, theTMSTracerCfg, theTMSTracer );
...
WIRE(theBus, Writes,                    theTMSTracer, Writes)
WIRE(theBus, Reads,                     theTMSTracer, Reads)
WIRE(theBus, Fetches,                   theTMSTracer, Fetches)

WIRE(theL2, Reads,                      theTMSTracer, L2Reads)
WIRE(theL2, Writes,                     theTMSTracer, L2Writes)
WIRE(theL2, Fetches,                    theTMSTracer, L2Fetches)
